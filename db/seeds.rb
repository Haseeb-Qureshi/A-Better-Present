...
CardDesign.create(path: "assets/design1.jpg")
CardDesign.create(path: "assets/design2.jpg")
CardDesign.create(path: "assets/design3.jpg")
CardDesign.create(path: "assets/design4.jpg")
